...
def run_migrations():
    ...
    migrations = [
        ...
        # ------------------------------------------------------------------
        # CREATE royal21_tables TABLE
        # ------------------------------------------------------------------
        """
        CREATE TABLE IF NOT EXISTS royal21_tables (
            id SERIAL PRIMARY KEY,
            table_name VARCHAR(100) NOT NULL DEFAULT 'Royal 21 Table',
            ante INTEGER NOT NULL DEFAULT 10,
            min_buyin INTEGER NOT NULL DEFAULT 100,
            max_buyin INTEGER NOT NULL DEFAULT 1000,
        ...
        # ------------------------------------------------------------------
        # CREATE royal21_seats TABLE
        # ------------------------------------------------------------------
        """
        CREATE TABLE IF NOT EXISTS royal21_seats (
            id SERIAL PRIMARY KEY,
            table_id INTEGER NOT NULL REFERENCES royal21_tables(id) ON DELETE CASCADE,
            seat_number INTEGER NOT NULL,
            user_id INTEGER NOT NULL REFERENCES users(id),
            coins_escrowed INTEGER NOT NULL,
